...
class PdfGenerator {
  static Future<Uint8List> generatePdfBytes(Map<String, dynamic> data, PdfPageFormat format) async {
    ...
    final brandLightBlue = PdfColor.fromHex('#E0E7FF'); // Very Light Blue (Replaces opacity)
                ...
                pw.Positioned.fill(
                    child: pw.Center(
                        child: pw.Transform.rotateBox(
                          angle: 0.5,
                          child: pw.Text('Rx', style: pw.TextStyle(fontSize: 300, color: PdfColors.grey100, fontWeight: pw.FontWeight.bold, fontStyle: pw.FontStyle.italic)),
                        )
                    )
                ),
                            ...
                            children: [
                              ...
                              pw.Expanded(
                                  ...
                                  child: pw.Container(
                                      ...
                                      decoration: pw.BoxDecoration(border: pw.Border(right: pw.BorderSide(color: borderGray, width: 1))),
                                      child: pw.Column(
                                          crossAxisAlignment: pw.CrossAxisAlignment.start,
                                          children: [
                                            if (data['diagnosis'] != null && data['diagnosis'].toString().isNotEmpty)
                                              _buildSidebarSection('DIAGNOSIS', data['diagnosis'], accentTeal, primaryDark),
                                            if (data['pastHistory'] != null && data['pastHistory'].toString().isNotEmpty)
                                              _buildSidebarSection('PAST HISTORY', data['pastHistory'], accentTeal, primaryDark),
                                            if (data['investigations'] != null && data['investigations'].toString().isNotEmpty)
                                              _buildSidebarSection('INVESTIGATIONS', data['investigations'], accentTeal, primaryDark),
                                            if (data['diet'] != null && data['diet'].toString().isNotEmpty)
                                              _buildSidebarSection('DIET', data['diet'], accentTeal, primaryDark),
                                            if (data['advice'] != null && data['advice'].toString().isNotEmpty)
                                              _buildSidebarSection('ADVICE', data['advice'], accentTeal, primaryDark),
                                          ]
                                      )
                                  )
                              ),
                              ...
                              pw.Expanded(
                                  ...
                                  child: pw.Column(
                                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                                      children: [
                                        pw.Text('Rx', style: pw.TextStyle(fontSize: 42, color: brandBlue, fontStyle: pw.FontStyle.italic, fontWeight: pw.FontWeight.bold)),
                                        pw.SizedBox(height: 16),
                                        ...
                                        if (data['emptyStomachMedicines'] != null && (data['emptyStomachMedicines'] as List).isNotEmpty) ...[
                                          ...
                                          ..._buildKickAssMedList(data['emptyStomachMedicines'], dangerText, textMuted),
                                          pw.SizedBox(height: 16),
                                        ],

                                        if (data['medicines'] != null && (data['medicines'] as List).isNotEmpty) ...[
                                          ..._buildKickAssMedList(data['medicines'], primaryDark, textMuted),
                                        ],
                                      ]
                                  )
                              )
                        ...
                        children: [
                          ...
                          pw.Column(
                              ...
                              children: [
                                ...
                                pw.Text('* This Prescription is not valid for medicolegal purpose.', style: pw.TextStyle(fontSize: 8, color: textMuted, fontWeight: pw.FontWeight.bold)),
                                pw.SizedBox(height: 4),
                                ...
                                pw.SizedBox(height: 4),
                                pw.Text("Designed & Developed @Rashi Lab.Proudly Made in India.", style: pw.TextStyle(fontSize: 8, color: PdfColors.grey400)),
                              ]
                          ),
          ...
          child: pw.Row(
              ...
              children: [
                ...
                pw.Container(
                    ...
                    child: pw.Text('${entry.key + 1}.', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 11, color: textMuted))
                ),
                ...
                pw.Expanded(
                    child: pw.Column(
                        ...
                        children: [
                          ...
                          pw.Row(
                              ...
                              children: [
                                ...
                                pw.Container(
                                  ...
                                  decoration: pw.BoxDecoration(
                                      color: PdfColor.fromHex('#E0E7FF'), // Very Light Blue
                                      borderRadius: const pw.BorderRadius.all(pw.Radius.circular(4)),
                                      border: pw.Border.all(color: PdfColor.fromHex('#C7D2FE'))
                                  ),
                                  child: pw.Text(
                                      entry.value['frequency']!,
                                      style: pw.TextStyle(fontSize: 8, fontWeight: pw.FontWeight.bold, color: PdfColor.fromHex('#3730A3'))
                                  ),
                                )
                              ]
                          ),
                          ...
                          pw.SizedBox(height: 6),
                          pw.Divider(color: PdfColor.fromHex('#F1F5F9'), thickness: 1) // Ultra subtle bottom line
                        ]
                    )
                ),
              ]
